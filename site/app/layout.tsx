...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const socialImage = new URL("/og-v2.png", `${protocol}://${host}`).toString();
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      images: [{ url: socialImage, width: 1738, height: 909, alt: "CHQ - Set up a private job-search system on your Windows PC." }],
    },
